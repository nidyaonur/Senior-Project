...
class SubscriberCreate extends Component {
  ...
  createSubscribers(data){
    const endpoint = '/api/subscribers/create/'
    ...
    render(){
        return (
            <form onSubmit={this.handleSubmit} ref={(el) => this.subscriberCreateForm = el}>
                ...
                <div className='form-group'>
                    <label for='fullname'>Subscriber Name</label>
                    <input type='text' id='fullname' name='fullname' className='form-control' placeholder='Subscriber Name' onChange={this.handleInputChange} required='true' />
                </div>
                <div className='form-group'>
                    <label for='username'>Subscriber Username</label>
                    <input type='text' id='username' name='username' className='form-control' placeholder='Subscriber Username' onChange={this.handleInputChange} required='true' />
                </div>
