...
class SubscriberCreate extends Component {
    ...
    state = {
        // this can also be placed inside constructor
        title: null,
        fullname: null,
        username: null
    };
    ...
    render() {
        return (
            <form
                ...
                ref={el => (this.subscriberCreateForm = el)}
            >
                <br></br>
                <div className="form-group">
                    <label htmlFor="title">Subscriber Title</label>
                    <input
                        type="text"
                        id="title"
                        name="title"
                        ref={this.subscriberTitleRef}
                        className="form-control"
                        placeholder="Subscriber Title"
                        onChange={this.handleInputChange}
                        required="true"
                    />
                </div>
                <div className="form-group">
                    <label htmlFor="fullname">Subscriber Name</label>
                    <input
                        type="text"
                        id="fullname"
                        name="fullname"
                ...
                <div className="form-group">
                    <label htmlFor="username">Subscriber Username</label>
                    <input
                        type="text"
                        id="username"
                        name="username"
